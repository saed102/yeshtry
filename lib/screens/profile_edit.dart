...
class _ProfileEditState extends State<ProfileEdit> {
  ...
  appExitDialog() {
    showDialog(
        ...
        builder: (context) => Directionality(
          ...
          child: AlertDialog(
            content: Text( app_language_rtl.$ ? "هل أنت متأكد أنك تريد حذف هذا الحساب؟": "are you sure you want to delete this account?"),
            actions: [
              FlatButton(
                  onPressed: () {
                   _delateAccount();
  ...
  _delateAccount()async{
    var profileUpdateResponse =
    await ProfileRepository().delateAccountResponse();
              ...
              Container(
                ...
                child: ClipRRect(
                    ...
                    child: FadeInImage.assetNetwork(
                      ...
                      image:  avatar_original.$??"https://yeshtry.com/public/assets/img/avatar-place.png",
                      fit: BoxFit.fill,
                    )),
              ),
              Positioned(
