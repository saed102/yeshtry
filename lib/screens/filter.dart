...
class _FilterState extends State<Filter> {
  ...
  int _lodingBrandIndex=2;
  int _lodingProuductIndex=2;
  int _lodingShopIndex=2;
  //----------------------------------------
  ...
  fetchProductData() async {
    ...
    //print("sb:"+_selectedBrands.join(",").toString());
      ...
      if(_productList.length.isEven){
        _lodingProuductIndex=2;
      }
      if(_productList.length.isOdd){
        _lodingProuductIndex=3;
      }
      if(_productList.length==_totalProductData){
        _lodingProuductIndex=0;
      }
      setState(() {});
  }
  ...
  fetchBrandData() async {
      ...
      if(_brandList.length.isEven){
        _lodingBrandIndex=2;
      }
      if(_brandList.length.isOdd){
        _lodingBrandIndex=3;
      }
      if(_brandList.length==_totalBrandData){
        _lodingBrandIndex=0;
      }
      setState(() {});
  }
  ...
  List<DropdownMenuItem<WhichFilter>> buildDropdownWhichFilterItems(List which_filter_list) {
  ...
  Container buildProductLoadingContainer() {
    return Container(
      height: _showProductLoadingContainer&&_totalProductData == _productList.length ? 36 : 0,
  ...
  Container buildBrandLoadingContainer() {
    return Container(
      height: _showBrandLoadingContainer&&_totalBrandData == _brandList.length ? 36 : 0,
      width: double.infinity,
      color: Colors.white,
      child: Center(
        child: Text( AppLocalizations.of(context).common_no_more_products),
  ...
  Container buildShopLoadingContainer() {
    return Container(
      height: _showShopLoadingContainer&&_totalShopData == _shopList.length ? 36 : 0,
      width: double.infinity,
      color: Colors.white,
      child: Center(
        child: Text( AppLocalizations.of(context).common_no_more_products),
          ...
          child: Column(
            children: [
              ...
              GridView.builder(
                ...
                itemCount: _productList.length+_lodingProuductIndex,
          ...
          child: Column(
            children: [
              ...
              GridView.builder(
                // 2
                //addAutomaticKeepAlives: true,
                itemCount: _brandList.length+_lodingBrandIndex,
                controller: _scrollController,
                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                    crossAxisCount: 2,
                    crossAxisSpacing: 10,
          ...
          child: Column(
            children: [
              ...
              GridView.builder(
                // 2
                //addAutomaticKeepAlives: true,
                itemCount: _shopList.length+_lodingShopIndex,
                controller: _scrollController,
                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                    crossAxisCount: 2,
                    crossAxisSpacing: 10,
