...
class _ProductDetailsState extends State<ProductDetails> {
  ...
  buildDynamicLinks(String title,String image,String docId) async {
    String url = "http://yeshtry.page.link";
    final DynamicLinkParameters parameters = DynamicLinkParameters(
      uriPrefix: url,
      link: Uri.parse('$url/$docId'),
      androidParameters: AndroidParameters(
        packageName: "com.onatcipli.YESHTRY",
        minimumVersion: 0,
      ),
      iosParameters: IosParameters(
          bundleId: "com.onatcipli.YESHTRY",
          appStoreId: "1636565130",
          minimumVersion: "13.5"
      ),
    ...
    await   SocialShare.shareOptions(desc);
  }
  ...
  onPressShare() {
    buildDynamicLinks(_productDetails.name,_productDetails.thumbnail_image,_productDetails.id.toString(),);
  }
                ...
                child: Container(
                  ...
                  child: FadeInImage.assetNetwork(
                    ...
                    image: _productDetails.shop_logo ??
                        "https://yeshtry.com/public/assets/img/placeholder.jpg",
                    fit: BoxFit.cover,
                  ),
                ),
              ),
        ...
        ? InkWell(
            ...
            child: Row(
              children: [
                ...
                Spacer(),
                if (_productDetails.brand.logo != null)
                  Container(
                    width: 36,
                    height: 36,
                    decoration: BoxDecoration(
