...
import 'package:active_ecommerce_flutter/screens/rePay_order.dart';
...
class _OrderListState extends State<OrderList> {
  ...
  fetchData() async {
    ...
    _showLoadingContainer = false;
    if (_orderList.length == _totalData) {
      _lodingIndex = 0;
    }else{
      _lodingIndex=1;
    }
  ...
  Container buildLoadingContainer() {
    return Container(
      height: _showLoadingContainer && _totalData == _orderList.length ? 36 : 0,
      ...
      return RefreshIndicator(
        ...
        child: SingleChildScrollView(
          ...
          child: ListView.builder(
            ...
            itemCount: _orderList.length + _lodingIndex,
            scrollDirection: Axis.vertical,
            physics: NeverScrollableScrollPhysics(),
            shrinkWrap: true,
            itemBuilder: (context, index) {
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  if (_orderList[index].payment_status == "unpaid") Spacer(),
                  if (_orderList[index].payment_status == "unpaid")
                    ElevatedButton(
                        style: ButtonStyle(
                        ...
                        onPressed: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => rePayorder(
                                  oeder_ID: _orderList[index].id,
                                ),
                              ));
                          print(_orderList[index].id);
                        },
                        child: Text(
                          !app_language_rtl.$ ? "Repay" : "اعاده الدفع",
