...
class rePayst extends StatefulWidget {
  int oeder_ID;
  ...
  @override
  _rePaystState createState() => _rePaystState();
}

class _rePaystState extends State<rePayst> {
  ...
  getSetInitialUrl() async {
    var paypalUrlResponse = await PaymentRepository().rePayorderst(
        widget.oeder_ID);
      ...
      return SingleChildScrollView(
        child: Container(
          ...
          child: WebView(
            ...
            onPageFinished: (page) {
              print("mohmknknkn ${page.toString()}");
